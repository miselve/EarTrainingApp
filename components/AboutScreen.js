...
export function AboutScreen({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.body}>This app was crafted using React Native by Michail Selvesakis & Gerasimos Harizanis as a project for 'Educational Innovation and Application Development,' a component of Democritus University of Thrace's curriculum.</Text>
