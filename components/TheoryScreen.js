...
export function TheoryScreen({ navigation }) {
  ...
  const [songs, setSongs] = useState([
    ...
    "Ascending major 6th: Dashing Through the Snow (Jingle Bells)",
    "Ascending minor 7th: Star Trek Original Series Theme Song",
    "Ascending major 7th: Superman Theme Song",
    "Ascending Octave: Alice in Wonderland - Somewhere over the Rainbow",
    " ",
    "Descending Minor 2nd: Not Added",
    "Descending Major 2nd: Not Added",
    "Descending Minor 3rd: Not Added",
    "Descending Major 3rd: Not Added",
    "Descending perfect 4th: Not Added",
    "Descending Tritone: Not Added",
    "Descending perfect 5th: Not Added",
    "Descending minor 6th: Not Added",
    "Descending major 6th: Not Added",
    "Descending minor 7th: Not Added",
    "Descending major 7th: Not Added",
    "Descending Octave: Not Added",
  ]);
